...
namespace CheatMod
{
    ...
    public class CheatMod : NimbatusMod
    {
        ...
        public override void OnEnable()
        {
            ...
            On.Assets.Nimbatus.Scripts.WorldObjects.Items.DroneParts.DronePartResources.ResourceTank.Update += ResourceTank_Update;
        }

        private void ResourceTank_Update(On.Assets.Nimbatus.Scripts.WorldObjects.Items.DroneParts.DronePartResources.ResourceTank.orig_Update orig, ResourceTank self)
        {
            self.SetResourceAmount(self.ResourceCapacity);
            orig(self);
        }

        private void FuelTank_Awake(On.Assets.Nimbatus.Scripts.WorldObjects.Items.DroneParts.FuelTanks.FuelTank.orig_Awake orig, FuelTank self)
        {
        ...
        private void Battery_Awake(On.Assets.Nimbatus.Scripts.WorldObjects.Items.DroneParts.Batteries.Battery.orig_Awake orig, Assets.Nimbatus.Scripts.WorldObjects.Items.DroneParts.Batteries.Battery self)
        {
