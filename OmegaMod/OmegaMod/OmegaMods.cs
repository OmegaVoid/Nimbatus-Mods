...
namespace OmegaMods
{
	...
	{
		public KeyBinding _activateShield = new KeyBinding("Activate", KeyCode.None);
		public KeyBinding _decreaseSize = new KeyBinding("Shrink", KeyCode.None);
		public KeyBinding _increaseSize = new KeyBinding("Grow", KeyCode.None);
		public float SizePerSecond = 1f;
		private orig(self);
		private AddKeyBindings(this.
